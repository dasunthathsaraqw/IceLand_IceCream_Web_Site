  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const promotions = Array.isArray(promotionsRes.data) ? promotions.data.data : [];
        const inquiries = Array.isArray(inquiriesRes.data) ? inquiries.data.data : [];
        setStats({
                        ...
                        <tr>
                          ...
                          {reportData.type === 'inquiries' && (
                            <>
                              ...
                              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900">Cart Items</th>
                            </>
                          )}
                        </tr>
                      </thead>
                        ...
                        {Array.isArray(reportData.data) &&
                          reportData.data.map((item, index) => (
                            <tr key={`${item._id || index}`} className="hover:bg-gray-50 transition-colors duration-150">
                              ...
                              {reportData.type === 'promotions' && (
                                <>
                                  <td className="px-6 py-4 text-sm font-medium text-gray-900">{item.offer || 'N/A'}</td>
                                  <td className="px-6 py-4 text-sm text-gray-600">
                              ...
                              {reportData.type === 'inquiries' && (
                                <>
                                  ...
                                  <td className="px-6 py-4 text-sm text-gray-600 max-w-xs truncate">{item.message || 'N/A'}</td>
                                  <td className="px-6 py-4 text-sm text-gray-600">
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
