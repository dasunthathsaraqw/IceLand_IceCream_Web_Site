...
const Footer = () => {
  return (
    <footer className="bg-[#FFECDB] text-[#FF9149] py-10 z-0">
      <div className="max-w-7xl mx-auto px-6 relative z-1">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 items-start">
          
          {/* Social Links */}
          <div className="space-y-4">
            <h3 className="text-base font-semibold text-[#FF9149] uppercase tracking-wider">Follow Us</h3>
            <div className="flex space-x-4">
              <a 
                href="https://facebook.com" 
                className="group p-2 rounded-full bg-[#FF9149]/20 hover:bg-[#E07B39] transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
              >
                <svg className="h-5 w-5 text-[#FF9149] group-hover:text-[#FFFFFF] transition-transform" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-base font-semibold text-[#FF9149] uppercase tracking-wider">Contact</h3>
            <div className="space-y-2">
              <p className="text-sm text-[#4A2C0D] hover:text-[#E07B39] transition-colors cursor-pointer">
          ...
          <div className="space-y-4 md:text-right">
            <h3 className="text-base font-semibold text-[#FF9149] uppercase tracking-wider">Company</h3>
            <div className="space-y-2">
              <p className="text-sm text-[#4A2C0D]">
                IceCream Delight
              </p>
              <p className="text-sm text-[#4A2C0D]/80">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 pt-6 border-t border-[#FF9149]/20">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            <p className="text-sm text-[#4A2C0D]/80">
              © {new Date().getFullYear()} IceCream Delight. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <span className="text-sm text-[#4A2C0D] hover:text-[#E07B39] transition-colors cursor-pointer">
                Privacy Policy
              </span>
              <span className="text-sm text-[#4A2C0D] hover:text-[#E07B39] transition-colors cursor-pointer">
                Terms of Service
